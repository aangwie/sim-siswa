...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        // 1. Update Pribadi
        $stmt1 = $conn->prepare("UPDATE siswa_pribadi SET nisn=?, nik=?, nama_lengkap=?, kelas=?, jenis_kelamin=?, tanggal_lahir=?, status=? WHERE siswa_id=?");
        $stmt1->bind_param("sssssssi", $_POST['nisn'], $_POST['nik'], $_POST['nama'], $_POST['kelas'], $_POST['jk'], $_POST['tgl_lahir'], $_POST['status'], $id);
        $stmt1->execute();
...
<head>
    ...
    <style>
        ...
        .section-header {
            ...
            display: flex; align-items: center; margin-bottom: 1.5rem; padding-bottom: 0.5rem;
        ...
        .form-control:focus, .form-select:focus {
            border-color: var(--primary-color); box-shadow: 0 0 0 3px rgba(15, 23, 42, 0.1);
        }
    </style>
</head>
<body>
